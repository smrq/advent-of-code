...
assert.strictEqual(30, score(`R8,U5,L5,D3
U7,R6,D4,L4`));
assert.strictEqual(610, score(`R75,D30,R83,U83,L12,D49,R71,U7,L72
U62,R66,U55,R34,D71,R55,D58,R83`));
assert.strictEqual(410, score(`R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51
...
function score(pathStr) {
	...
	return intersections.map(x => x[2]).sort((a, b) => a - b)[0];
}
...
function calculateLines(path) {
	...
	for (let command of path) {
		...
		result.push({ x1, y1, x2, y2, initialSteps });
